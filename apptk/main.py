...
# Load the image
image = tkinter.PhotoImage(file="images/iconlogin.png")
# Create a label and add the image to it
label = tkinter.Label(freme,image=image)
label.config(width=600) # hadi hajm image bach ji lfo9

labelentryu = ttk.Label(text="USER NAME",background=bg,font=font,foreground='white') #label user name
labelentryp = ttk.Label(text="PASSWORD",background=bg,font=font,foreground='white') #label password
